import WallpapersBody from "@/components/resources/wallpapers/wallpapers_body";
...
export default async function WallpapersPage({ params, searchParams }) {
    const locale = (await params).locale;

    return(
        <>
            <WallpapersBody lang={locale} />
        </>
    )
}