...
function Attachment ({attachmentFile}){
    ...
    //#region view
    return(
        <div className="font-['Montserrat'] mt-6 mx-4 max-w-(--breakpoint-xl) xl:mx-auto">
            <div className="text-[1rem] flex flex-col gap-0 lg:flex-row lg:flex-wrap lg:mx-auto lg:mt-0 max-w-(--breakpoint-md)">
                <div className="flex flex-[0_1_auto] flex-col w-full">
                    <span className="text-black font-['Michroma'] uppercase text-[1.5rem] leading-[1.2rem] flex-none">{fT('title')}</span>
                    <div className="border border-[#d5d5d5] rounded-[10px] font-['Montserrat'] text-[1rem] bg-transparent w-full h-8 outline-hidden
