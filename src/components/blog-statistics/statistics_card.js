...
const StatisticsCard = () => {
    ...
    return (
        ...
        z-100 xl:w-full xl:mx-auto font-['lora'] select-none">
            {/* <h2 className="font-['lora'] font-medium text-[2.25rem] leading-8 flex items-center justify-center text-center
            ...
            >
                ...
                min-h-24 font-semibold px-2 py-4 gap-2">
                    <div className="flex flex-row items-center justify-center gap-2">
                        <h2 className="w-full text-[4rem] leading-[3.8rem] font-['lora']">{data.averageViews}</h2>
                    ...
                    <div className="flex flex-row items-center justify-center gap-2">
                        {
                            ...
                            <Link
                                className="w-full text-[2rem] leading-8 font-['lora']" 
                                href={``}
                            >
                                {data.mostViews.title}
                            </Link>
                            :
                            <h2 className="w-full text-[2rem] leading-8 font-['lora']">-</h2>
                        }
                        <span className="material-symbols-outlined notranslate text-[3rem]" >
                            thumb_up_off_alt
                        </span>
                ...
                min-h-24 font-semibold px-2 py-4 gap-2">
                    <div className="flex flex-row items-center justify-center gap-2">
                        <h2 className="w-full text-[4rem] leading-[3.8rem] font-['lora']">{data.totalPosted}</h2>
                        <span className="material-symbols-outlined notranslate text-[3rem]" >
                            note
                        </span>
                    </div>
