...
function RelantlessPursuit(){
    ...
    return(
        <div className="flex flex-col text-center items-center justify-center relative overflow-hidden px-4 h-120
            lg:p-0 lg:h-80 lg:max-w-screen-lg  lg:my-8 lg:mx-auto object-fill bg-black">
            ...
            />
            <span className="z-10 font-['lora'] text-white font-medium text-[2.25rem] leading-8 text-center
                lg:text-[4.8rem] lg:leading-16 uppercase">
                {
                    //font-['lora'] font-bold leading-10 uppercase text-[2rem] text-shadow lg:text-[2.5rem] lg:leading-[2.75rem] h-auto lg:h-[3.5rem]
                    t.rich('slogan', {
                    white: (chunks) => <span className="z-10 text-white font-['lora'] font-bold leading-10 uppercase text-[1.5rem] text-shadow lg:text-[2rem] lg:leading-[2.75rem] h-auto lg:h-[3.5rem]">{chunks}</span>,
                    orange: (chunks) => <span className="z-10 text-primary-light-color font-['lora'] font-bold leading-10 uppercase text-[1.5rem] text-shadow lg:text-[2rem] lg:leading-[2.75rem] h-auto lg:h-[3.5rem]">{chunks}</span>,
                    })
                }
            </span>
