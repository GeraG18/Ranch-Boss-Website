...
//   title: 'Privacy Policy | Horizon Trailers',
//   authors:[{name: "Horizon Trailers LLC"}],
//   description: "Learn about Horizon Trailers' Privacy Policy, detailing how we collect, use, and protect your personal information. Committed to transparency and security, we ensure your data is handled responsibly to safeguard your privacy while you browse and interact with our website.",
...
//   openGraph: {
//     title: 'Privacy Policy | Horizon Trailers Facebook',
//     description: "Learn about Horizon Trailers' Privacy Policy, detailing how we collect, use, and protect your personal information. Committed to transparency and security, we ensure your data is handled responsibly to safeguard your privacy while you browse and interact with our website.",
...
//     title: 'Privacy Policy | Horizon Trailers X',
//     description: "Learn about Horizon Trailers' Privacy Policy, detailing how we collect, use, and protect your personal information. Committed to transparency and security, we ensure your data is handled responsibly to safeguard your privacy while you browse and interact with our website.",
...
export async function generateMetadata({ params }) {
  ...
  const t = await getTranslations({ locale, namespace: 'SEOMetadata.PrivacyPolicy' });
  return {
    metadataBase: new URL('https://horizontrailers.com'),
    title: t('title'),
    authors:[{name: "Horizon Trailers LLC"}],
