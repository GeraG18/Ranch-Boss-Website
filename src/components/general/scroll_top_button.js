...
const ScrollTopButton = () => {
    ...
    return (
        <div id="scroll-top-button" className="fixed bottom-[20%] left-0 *lg:right-2 border-none bg-primary-color text-white flex flex-col items-center 
        justify-center font-['Montserrat'] uppercase rounded-r-lg *lg:rounded-r-lg p-4 lg:p-2 cursor-pointer z-450 motion-safe:transition-all 
