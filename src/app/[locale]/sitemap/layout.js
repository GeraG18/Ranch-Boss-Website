...
//   title: 'Our Sitemap | Horizon Trailers',
//   authors:[{name: "Horizon Trailers LLC"}],
//   description: "Navigate Horizon Trailers’ sitemap for quick access to essential pages, including product categories, warranty documents, contact information, and more. Easily find everything you need to explore our durable trailers and services designed to meet your hauling needs.",
...
//   openGraph: {
//     title: 'Our Sitemap | Horizon Trailers Facebook',
//     description: "Navigate Horizon Trailers’ sitemap for quick access to essential pages, including product categories, warranty documents, contact information, and more. Easily find everything you need to explore our durable trailers and services designed to meet your hauling needs.",
...
//     title: 'Our Sitemap | Horizon Trailers X',
//     description: "Navigate Horizon Trailers’ sitemap for quick access to essential pages, including product categories, warranty documents, contact information, and more. Easily find everything you need to explore our durable trailers and services designed to meet your hauling needs.",
...
export async function generateMetadata({ params }) {
  ...
  const t = await getTranslations({ locale, namespace: 'SEOMetadata.Sitemap' });
  return {
    metadataBase: new URL('https://horizontrailers.com'),
    title: t('title'),
    authors:[{name: "Horizon Trailers LLC"}],
