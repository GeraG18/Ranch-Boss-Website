...
function OurFinancers (){
    ...
    //#region view
    return(
        <div className="my-8 min-h-120 flex flex-col items-center mx-4 max-w-(--breakpoint-xl) z-100
            xl:mx-auto">
            <div className="hidden flex-row gap-8 lg:flex">
            {
                Object.keys(financers).map((financerId, index) => (
                    <button key={financerId} onClick={() => { setActiveButton(financerId)}} className={`font-['Michroma'] text-[2rem] leading-[1.8rem] border-none z-50 w-fit
            ...
            <div className="hidden flex-col lg:flex">
                <h2 className="font-['Michroma'] text-[2rem] uppercase pl-0 self-start lg:pt-[1.8rem]">
                ...
                <div className="flex flex-col gap-4 w-full">
                    <div className="h-full flex items-center justify-center flex-col-reverse gap-8 lg:flex-row">
                        <p className="p-0 m-0 h-72 overflow-hidden w-full font-['Montserrat'] text-[1rem] flex flex-col gap-8">
                    ...
                    <div className="text-black flex flex-col gap-4 self-center w-full lg:flex-row lg:gap-10">
                        <a href={financers[activeButton].infoButton} target="_blank" 
                            className="font-['Montserrat'] cursor-pointer relative text-white border-none bg-primary-color text-[1rem] select-none flex items-center justify-center 
                            motion-safe:transition-all motion-reduce:transition-none will-change-auto motion-safe:duration-300 rounded-[10px] py-2 pointer-events-auto
                        ...
                        <Link href="/find-a-dealer" className="font-['Montserrat'] cursor-pointer relative text-white border-none bg-primary-color text-[1rem] select-none flex items-center justify-center 
                            motion-safe:transition-all motion-reduce:transition-none will-change-auto motion-safe:duration-300 rounded-[10px] py-2 pointer-events-auto
                        ...
                        <a href={financers[activeButton].applyButton} target="_blank"  className="font-['Montserrat'] cursor-pointer relative text-white border-none bg-primary-color text-[1rem] select-none flex items-center justify-center 
                            motion-safe:transition-all motion-reduce:transition-none will-change-auto motion-safe:duration-300 rounded-[10px] py-2 pointer-events-auto
                    ...
                    Object.keys(financers).map((active, index) => (
                        <div className="flex gap-4 flex-col w-full" 
                            ...
                            <div className="w-full h-full flex items-center justify-center flex-col gap-8 lg:flex-row">
                                ...
                                <p className="h-full font-['Montserrat'] text-[1rem] flex flex-col gap-8">
                                    {financers[active].body}
                                </p>
                            </div>
                            <div className="text-black flex flex-col gap-4 self-center w-full lg:flex-row lg:gap-10">
                                <a href={financers[active].infoButton} target="_blank" className="font-['Montserrat'] cursor-pointer relative text-white border-none bg-primary-color text-[1rem] select-none flex items-center justify-center 
                                    motion-safe:transition-all motion-reduce:transition-none will-change-auto motion-safe:duration-300 rounded-[10px] py-2 pointer-events-auto
                                    w-full lg:w-60 lg:px-6 lg:hover:bg-gradient-to-b lg:hover:from-secondary-color lg:hover:to-primary-color font-medium uppercase">{t('information')}</a>
                                <Link href="/find-a-dealer" className="font-['Montserrat'] cursor-pointer relative text-white border-none bg-primary-color text-[1rem] select-none flex items-center justify-center 
                                    motion-safe:transition-all motion-reduce:transition-none will-change-auto motion-safe:duration-300 rounded-[10px] py-2 pointer-events-auto
                                    w-full lg:w-60 lg:px-6 lg:hover:bg-gradient-to-b lg:hover:from-secondary-color lg:hover:to-primary-color font-medium uppercase">{t('locateDealer')}</Link>
                                <a href={financers[active].applyButton} target="_blank" className="font-['Montserrat'] cursor-pointer relative text-white border-none bg-primary-color text-[1rem] select-none flex items-center justify-center 
                                    motion-safe:transition-all motion-reduce:transition-none will-change-auto motion-safe:duration-300 rounded-[10px] py-2 pointer-events-auto
                                    w-full lg:w-60 lg:px-6 lg:hover:bg-gradient-to-b lg:hover:from-secondary-color lg:hover:to-primary-color font-medium uppercase">{t('apply')}</a>                        
                            </div>
                        </div>
