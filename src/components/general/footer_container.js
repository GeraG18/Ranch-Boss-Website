...
import RbLogoHorizontalWeathered from "../icons/logotypes/logo-horizontal-weathered";
...
function FooterContainer(){
    ...
    return(
        <div className="flex flex-col select-none notranslate">
            <div className="h-auto flex flex-row items-center justify-center bg-primary-color py-[3%] px-4 lg:px-0 lg:pt-[1%] lg:pb-[2%] border-t-2 border-t-secondary-color">
                <div className="flex mx-4 flex-col max-w-screen-lg  w-full gap-8 lg:flex-row xl:mx-auto">
                    <div className="flex flex-col items-center justify-center lg:w-[30%] lg:items-start">
                        <div className="w-[245px] h-[140px] py-5 px-[10px] shrink-3 relative">
                            ...
                            /> */}
                            <RbLogoHorizontalWeathered className="text-white"/>
                        </div>
                        ...
                        <div className="flex flex-wrap items-center gap-4 text-white">
                            ...
                            className="text-[#d9dcdc] lg:hover:text-secondary-color
                        ...
                        <div className="font-['oswald'] font-bold text-[1rem] my-[3%] text-left text-[#d9dcdc] col-start-1 uppercase">{mcT('title')}</div>
                    ...
                    <div className="w-full flex flex-col gap-3">
                        <div className="flex flex-row h-full gap-[40px] text-white font-['oswald'] text-[1rem] lg:hidden">
                            <ul className="w-full inline-flex flex-col gap-4 bg-transparent list-none
                                ...
                                <li className="py-1 motion-safe:transition-all motion-reduce:transition-none will-change-auto motion-safe:duration-400
                                    border border-secondary-color-20 bg-primary">
                                    <div onClick={()=>showOrHideCheckBox("products")} className="py-[0.8rem] px-[0.4rem] text-[0.875rem]
                                        ...
                                        motion-safe:duration-400 text-secondary-color">
                                        <span className="w-full uppercase flex items-center text-seconda">
                                            {t('products')}
                                        </span>
                                        <span className={`material-symbols-outlined notranslate motion-safe:transition-all 
                                    ...
                                    <div className={`flex flex-col gap-[0.2rem] motion-safe:transition-all 
                                        ...
                                        <div className="flex flex-col h-0 overflow-hidden motion-safe:transition-all motion-reduce:transition-none 
                                            ...
                                            <CustomLink className="cursor-pointer h-10 text-[1rem] flex items-center justify-start lg:h-auto lg:hover:text-secondary-color 
                                                motion-safe:transition-all motion-reduce:transition-none will-change-auto motion-safe:duration-400" 
                                ...
                                <li className="py-1 border border-secondary-color-20 bg-primary motion-safe:transition-all 
                                        motion-reduce:transition-none will-change-auto motion-safe:duration-400 ">
                                    <div onClick={()=>showOrHideCheckBox("support")} 
                                        className="py-[0.8rem] px-[0.4rem] text-[0.875rem] cursor-pointer flex items-center 
                                ...
                                <li className="py-1 border border-secondary-color-20 bg-primary motion-safe:transition-all 
                                    ...
                                    <div className="flex flex-col gap-[0.2rem] motion-safe:transition-all motion-reduce:transition-none 
                                        ...
                                        <div className="flex flex-col h-0 overflow-hidden motion-safe:transition-all motion-reduce:transition-none 
                                            ...
                                            {/* <CustomLink className="text-[#d9dcdc] lg:hover:text-secondary-color" href="/" className="cursor-pointer h-10 text-[1rem] flex items-center justify-start lg:h-auto lg:hover:text-secondary-color 
                                            ...
                                            <CustomLink href="/become-a-dealer" className="cursor-pointer h-10 text-[1rem] flex items-center justify-start lg:h-auto lg:hover:text-secondary-color 
                                ...
                                {/* <li className="py-1 border border-secondary-color-20 bg-primary motion-safe:transition-all 
                                        motion-reduce:transition-none will-change-auto motion-safe:duration-400 text-secondary-color">
                        ...
                        <div className="hidden flex-row gap-1 h-full font-['oswald'] text-[1rem] lg:flex justify-between">
                            <div className="flex flex-col flex-wrap text-secondary-color-20 gap-5">
                                <span className="font-medium text-[0.875rem] uppercase text-secondary-color">{t('products')}</span>
                                <CustomLink className="cursor-pointer h-10 text-[0.85rem] flex items-center justify-start lg:h-auto lg:hover:text-secondary-color 
                            ...
                            <div className="flex flex-col flex-wrap text-secondary-color-20 gap-5">
                                <span className="font-medium text-[0.875rem] uppercase text-secondary-color">{t('support')}</span>
                                <CustomLink className="cursor-pointer h-10 text-[0.85rem] flex items-center justify-start lg:h-auto lg:hover:text-secondary-color 
                                                motion-safe:transition-all motion-reduce:transition-none will-change-auto motion-safe:duration-400" href="/warranty-claim">{t('warrantyClaim')}</CustomLink>
                                {/* <CustomLink className="cursor-pointer h-10 text-[0.85rem] flex items-center justify-start lg:h-auto lg:hover:text-secondary-color 
                                                motion-safe:transition-all motion-reduce:transition-none will-change-auto motion-safe:duration-400" href="/warranty-docs">{t('warrantyDocs')}</CustomLink>
                            ...
                            <div className="flex flex-col flex-wrap text-secondary-color-20 gap-5">
                                <span className="font-medium text-[0.875rem] uppercase text-secondary-color">{t('dealer')}</span>
                                {/* <CustomLink className="cursor-pointer h-10 text-[0.85rem] flex items-center justify-start lg:h-auto lg:hover:text-secondary-color 
                                                // motion-safe:transition-all motion-reduce:transition-none will-change-auto motion-safe:duration-400" href="/find-a-dealer">{t('findADealer')}</CustomLink> */}
                                {/* <CustomLink className="cursor-pointer h-10 text-[0.85rem] flex items-center justify-start lg:h-auto lg:hover:text-secondary-color 
                                                motion-safe:transition-all motion-reduce:transition-none will-change-auto motion-safe:duration-400">Dealer Port</CustomLink> */}
                            ...
                            {/* <div className="flex flex-col flex-wrap text-white gap-5">
                                <span className="font-medium text-[0.875rem] uppercase">{t('shop')}</span>
                                <CustomLink className="cursor-pointer h-10 text-[0.85rem] flex items-center justify-start lg:h-auto lg:hover:text-secondary-color 
                                                motion-safe:transition-all motion-reduce:transition-none will-change-auto motion-safe:duration-400" href="/merchandise">{t('merchandise')}</CustomLink>
                            </div> */}
                            <div className="flex flex-col flex-wrap text-secondary-color-20 gap-5">
                                <span className="font-medium text-[0.875rem] uppercase text-secondary-color">{t('company')}</span>
                                <CustomLink className="cursor-pointer h-10 text-[0.85rem] flex items-center justify-start lg:h-auto lg:hover:text-secondary-color 
                                                motion-safe:transition-all motion-reduce:transition-none will-change-auto motion-safe:duration-400" href="/about-us">{t('aboutUs')}</CustomLink>
                                <CustomLink className="cursor-pointer h-10 text-[0.85rem] flex items-center justify-start lg:h-auto lg:hover:text-secondary-color 
                                                motion-safe:transition-all motion-reduce:transition-none will-change-auto motion-safe:duration-400" href="/contact-us">{t('contactUs')}</CustomLink>
                            ...
                            <div className="flex flex-col flex-wrap text-secondary-color-20 gap-5">
                                <span className="font-medium text-[0.875rem] uppercase text-secondary-color">{t('insideTheTrailerWorld')}</span>
                                <CustomLink className="cursor-pointer h-10 text-[0.85rem] flex items-center justify-start lg:h-auto lg:hover:text-secondary-color 
                                                motion-safe:transition-all motion-reduce:transition-none will-change-auto motion-safe:duration-400" href="/blog">{t('blog')}</CustomLink> 
                                <CustomLink className="cursor-pointer h-10 text-[0.85rem] flex items-center justify-start lg:h-auto lg:hover:text-secondary-color 
                                                motion-safe:transition-all motion-reduce:transition-none will-change-auto motion-safe:duration-400" href="/resources">{t('resources')}</CustomLink> 
                        ...
                        {/* <CustomLink href="https://www.natm.com/"
                            className="font-medium text-[0.75rem] text-white! flex flex-row items-center justify-center
                        ...
                        <div className="font-['oswald'] uppercase text-[0.875rem] font-medium text-secondary-color-20 flex flex-col items-center justify-center
            ...
            <div className="bg-primary-color border-t border-t-secondary-color-20 flex flex-wrap items-center justify-center min-h-10 flex-row gap-8 
                lg:pl-16 pt-2 pb-2">
                <CustomLink href="/privacy-policy" className="text-sm font-['oswald'] text-secondary-color-20 lg:hover:text-secondary-color!
                ...
                <CustomLink href="/terms-of-use" className="text-sm font-['oswald'] text-secondary-color-20 lg:hover:text-secondary-color!
                    motion-safe:transition-all motion-reduce:transition-none will-change-auto uppercase 
                    motion-safe:duration-300">{t('termsOfUse')}</CustomLink>
                {/* <span className=" font-['lora'] hidden lg:block text-[12px]">|</span> */}
                <CustomLink href="/quality#faqs-section" className="text-sm font-['oswald'] text-secondary-color-20 lg:hover:text-secondary-color!
                    motion-safe:transition-all motion-reduce:transition-none will-change-auto uppercase 
                    motion-safe:duration-300">{t('faqs')}</CustomLink>
                {/* <span className=" font-['lora'] hidden lg:block text-[12px]">|</span> */}
                <CustomLink href="/sitemap" className="text-sm font-['oswald'] text-secondary-color-20 lg:hover:text-secondary-color!
                    motion-safe:transition-all motion-reduce:transition-none will-change-auto uppercase 
