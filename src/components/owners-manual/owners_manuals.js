...
function OwnersManuals (){
    ...
    return(
        <>
            <div className="h-fit flex flex-col my-4 lg:h-200 lg:flex-row lg:gap-8 mx-4 max-w-(--breakpoint-xl)
                z-100 xl:mx-auto">
                <div className="flex flex-col mb-4 gap-4 lg:mb-0">
                    <button onClick={() => {changePdfSource("/pdfs/DumpManual.pdf"); setActiveButton("dumps")}}
                        className={`font-['Montserrat'] uppercase font-semibold text-[#77787b] flex flex-row items-center
                            rounded-[10px] w-full h-12 text-[1rem] bg-[#f3f3f3] border-none cursor-pointer
