...
const WhyChooseArea = () => {
    ...
    return (
        <div className="w-full min-h-16 flex flex-col items-center mb-4">
            ...
            <div className="bg-white flex flex-col lg:flex-row gap-6 lg:gap-0 py-6 justify-center items-center mx-4 max-w-screen-lg h-fit z-80
                ...
                <div className="flex flex-col items-end justify-center relative w-full h-96">
                    ...
                    />
                    <ImageViewerAlt 
                        className="!h-[16rem] !w-[12rem] absolute! shadow-md bottom-0 left-16 self-center
                        motion-reduce:transition-none will-change-auto0 grayscale-60 brightness-140
                        after:content-[''] after:w-full after:h-full after:bg-tertiary-dark-color/50 after:absolute
                        after:left-0 after:top-0 after:2-50" 
