        ...
        <div className="relative h-[24rem] overflow-hidden flex items-center justify-center flex-col">
            <div className="absolute z-30 flex flex-col items-center justify-center -mb-8">
                <div className="relative flex items-end justify-center">
                    <RbIsotypeWeathered className="h-21 lg:h-42 text-secondary-color absolute z-20"/>
                    <RbNameWeathered className="h-16 lg:h-32 text-white opacity-20 z-10"/>
                </div>
                <span className="font-['BeerTime'] text-[2rem] lg:text-[3.5rem] text-white opacity-75">STReNgTh You CaN Haul ON</span>
            </div>
