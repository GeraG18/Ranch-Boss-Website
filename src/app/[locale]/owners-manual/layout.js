...
//   title: 'Owners Manual | Horizon Trailers',
//   authors:[{name: "Horizon Trailers LLC"}],
//   description: "Find Horizon Trailers’ Owner's Manuals with detailed instructions, safety guidelines, and maintenance tips. Ensure your trailer’s optimal performance and longevity with easy-to-follow guides tailored to each model. Download your manual today for hassle-free trailer operation.",
...
//   openGraph: {
//     title: 'Owners Manual | Horizon Trailers Facebook',
//     description: "Find Horizon Trailers’ Owner's Manuals with detailed instructions, safety guidelines, and maintenance tips. Ensure your trailer’s optimal performance and longevity with easy-to-follow guides tailored to each model. Download your manual today for hassle-free trailer operation.",
...
//     title: 'Owners Manual | Horizon Trailers X',
//     description: "Find Horizon Trailers’ Owner's Manuals with detailed instructions, safety guidelines, and maintenance tips. Ensure your trailer’s optimal performance and longevity with easy-to-follow guides tailored to each model. Download your manual today for hassle-free trailer operation.",
...
export async function generateMetadata({ params }) {
  ...
  const t = await getTranslations({ locale, namespace: 'SEOMetadata.OwnersManual' });
  return {
    metadataBase: new URL('https://horizontrailers.com'),
    title: t('title'),
    authors:[{name: "Horizon Trailers LLC"}],
