...
const WallpapersBody = ({lang}) => {
    ...
    return(
        <div className={`w-full left-0 top-0 before:bg-black before:w-full before:h-full before:absolute backdrop-saturate-50 backdrop-blur-sm
                z-900 flex flex-col items-center justify-center font-['lora'] h-[90dvh]`}>
            ...
            <div className="z-100 overflow-hidden relative mx-4 w-full flex flex-col bg-white text-black
                shadow-[rgba(0, 0, 0, 0.15)_0px_2px_10px] p-0 md:w-[24rem]">
                    {
                        sended && 
                        <div className={`absolute z-40 h-full font-['lora'] w-full flex flex-col items-center justify-center motion-safe:transition-all 
                            ...
                            <div className="max-w-(--breakpoint-md) xl:mx-auto flex flex-col items-center justify-center overflow-hidden p-2">
                                ...
                                <h1 className="font-['lora'] font-medium text-[1.5rem] leading-8 text-center w-full
                    ...
                    <form onSubmit={(e) => {e.preventDefault(); doWallpaperLogic()}}  
                        ...
                        <div className="flex flex-col items-start w-full gap-2">
                            <span className="font-['lora'] text-[2rem] w-fit uppercase text-center leading-tight">{t('slogan_title')}</span>
