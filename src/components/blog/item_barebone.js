            ...
            <div className="w-full h-full max-w-full flex flex-col">
                ...
                will-change-auto motion-safe:duration-300 bg-[rgba(119,120,123,0.3)]`}>
                    <div className="absolute left-0 top-0 z-30 w-full p-2 flex flex-row gap-2 overflow-hidden">
                        <div className="w-fit uppercase text-[0.85rem] backdrop-saturate-50 *backdrop-blur *bg-black/50">
                            <div className="w-16 flex-none bg-[rgba(255,255,255,1)] h-6">
                            </div>
                        </div>
                        <div className="w-fit uppercase text-[0.85rem] backdrop-saturate-50 *backdrop-blur *bg-black/50">
                            <div className="w-16 flex-none bg-[rgba(255,255,255,1)] h-6">
                    ...
                    before:h-40 before:pointer-events-">
                        <div className="w-1/2 flex-none bg-[rgba(255,255,255,1)] h-5">
                        </div>
                    </div>
                </div>

                <span className="my-2 w-full uppercase font-['lora'] text-[2rem] leading-9 text-black">
                    <div className="w-3/4 flex-none bg-[rgba(119,120,123,0.3)] h-9 lg:text-start ">
                    </div>
                </span>
                <div className="w-full text-black my-2 [&_p]:m-0 line-clamp-2">
                    <div className="w-full flex-none bg-[rgba(119,120,123,0.3)] h-10 lg:text-start ">
                    </div>
                </div>
                <div className="flex gap-1 flex-row items-center justify-start w-[16rem] text-black">
                    ...
                    <div className="w-3/4 flex-none bg-[rgba(119,120,123,0.3)] h-5 lg:text-start ">
                    </div>
                </div>
