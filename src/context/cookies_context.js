    ...
    return (
        <div className="z-800 pointer-events-none fixed bottom-0 left-0 m-4 max-w-[480px] motion-safe:transition-all motion-safe:duration-300 motion-reduce:transition-none will-change-auto">
            <div style={{pointerEvents: cookiesValue === null ? 'auto' : 'none', opacity:cookiesValue === null ? '1' : '0'}} 
                className="motion-safe:transition-all motion-safe:duration-300 motion-reduce:transition-none will-change-auto z-800 py-4 px-8 font-['Montserrat'] bg-white rounded-[10px]
        ...
        <CookieContext.Provider value={{ canUseCookies }}>
            <CookiesWrapper cookiesValue={canUseCookies}>
                ...
                <div onClick={() => setCanUseCookiesFn(true)} 
                        className="flex flex-row items-center justify-center font-['Montserrat'] text-[1rem] cursor-pointer w-full relative mt-4
                        bg-primary-color rounded-[10px] border border-primary-color text-white select-none motion-safe:transition-all motion-safe:duration-300 
                ...
                {/* <div className="flex flex-row gap-4">
                    <div onClick={() => setCanUseCookiesFn(false)} 
                        className="flex flex-row items-center justify-center font-['Montserrat'] text-[1rem] cursor-pointer w-full relative mt-4
                        bg-transparent rounded-[10px] border border-[#d5d5d5] text-[#4d4d4d] select-none motion-safe:transition-all motion-safe:duration-300 
