...
//   title: 'Warranty Docs | Horizon Trailers',
//   authors:[{name: "Horizon Trailers LLC"}],
//   description: "Access Horizon Trailers’ comprehensive warranty documentation for detailed coverage on frames, axles, and parts. Ensure peace of mind with our industry-leading warranties, designed to protect your investment and guarantee the long-lasting performance of your trailer.",
...
//   openGraph: {
//     title: 'Warranty Docs | Horizon Trailers Facebook',
//     description: "Access Horizon Trailers’ comprehensive warranty documentation for detailed coverage on frames, axles, and parts. Ensure peace of mind with our industry-leading warranties, designed to protect your investment and guarantee the long-lasting performance of your trailer.",
...
//     title: 'Warranty Docs | Horizon Trailers X',
//     description: "Access Horizon Trailers’ comprehensive warranty documentation for detailed coverage on frames, axles, and parts. Ensure peace of mind with our industry-leading warranties, designed to protect your investment and guarantee the long-lasting performance of your trailer.",
...
export async function generateMetadata({ params }) {
  ...
  const t = await getTranslations({ locale, namespace: 'SEOMetadata.WarrantyDocs' });
  return {
    metadataBase: new URL('https://horizontrailers.com'),
    title: t('title'),
    authors:[{name: "Horizon Trailers LLC"}],
