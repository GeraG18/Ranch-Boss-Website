...
function ExclusiveWallpapers(){
    ...
    return(
        <Link href="/resources/wallpapers" className="flex flex-col gap-2 text-center items-center justify-end relative overflow-hidden px-4 h-fit
                lg:px-0 lg:max-w-(--breakpoint-xl) *my-2 lg:my-8 py-4 lg:py-0 lg:mx-auto bg-black cursor-pointer" >
            <div className="flex flex-col text-center items-center justify-end w-full relative overflow-hidden px-4 h-120
                lg:px-0 lg:h-80 lg:max-w-(--breakpoint-xl) lg:mx-auto object-fill bg-black">
            ...
            <span className="z-10 font-['Michroma'] text-white font-medium text-[2.25rem] leading-tight text-center
                lg:leading-snug uppercase">
                {
                    t.rich('slogan', {
                    white: (chunks) => <span className="z-10 font-['Michroma'] text-white font-medium text-[2.25rem] leading-8 text-center ">{chunks}</span>,
                    orange: (chunks) => <span className="z-10 font-['Michroma'] text-primary-color font-medium text-[2.25rem] leading-8 text-center ">{chunks}</span>,
                    })
                }
            </span>
        </Link>
