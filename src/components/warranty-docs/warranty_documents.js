...
function WarrantyDocuments(){
    ...
    return(
        <div className="h-fit flex flex-col my-4 lg:h-200 lg:flex-row gap-8 mx-4 
            max-w-(--breakpoint-xl) z-100 xl:mx-auto">
                    ...
                    select-none lg:w-56">
                        <li className="p-0 rounded-[10px] border border-[#f3f3f3]">
                            <div onClick={()=>showOrHideLi("HORIZON")} className="px-3 flex flex-row items-center justify-center h-12 cursor-pointer font-bold bg-[#f3f3f3]">
                                <span className="w-full uppercase font-['Montserrat'] font-semibold text-[#77787b] bg-transparent border-none gap-[0.2rem]" >
                                    {t('horizon')}
                                </span>
                            ...
                            <div className="flex flex-col gap-[0.2rem]">
                                ...
                                className={`font-['Montserrat'] min-h-9 my-2 flex items-center justify-start w-full text-[1rem] bg-transparent border-none 
            ...
            <div className="flex h-[80vh] rounded-[10px] overflow-hidden flex-col w-full lg:h-auto">
                {
                    os === 'iOS' ? 
