...
//   title: 'Find a Dealer | Horizon Trailers',
//   authors:[{name: "Horizon Trailers LLC"}],
//   description: 'Find your nearest Horizon Trailers dealer with ease. Our trusted network of affiliates offers expert guidance, top-tier service, and access to our durable trailer lineup. Locate dealers near you to get the perfect trailer for your hauling needs today!',
...
//   openGraph: {
//     title: 'Find a Dealer | Horizon Trailers Facebook',
//     description: 'Find your nearest Horizon Trailers dealer with ease. Our trusted network of affiliates offers expert guidance, top-tier service, and access to our durable trailer lineup. Locate dealers near you to get the perfect trailer for your hauling needs today!',
...
//     title: 'Find a Dealer | Horizon Trailers X',
//     description: 'Find your nearest Horizon Trailers dealer with ease. Our trusted network of affiliates offers expert guidance, top-tier service, and access to our durable trailer lineup. Locate dealers near you to get the perfect trailer for your hauling needs today!',
...
export async function generateMetadata({ params }) {
  ...
  const t = await getTranslations({ locale, namespace: 'SEOMetadata.FindADealer' });
  return {
    metadataBase: new URL('https://horizontrailers.com'),
    title: t('title'),
    authors:[{name: "Horizon Trailers LLC"}],
