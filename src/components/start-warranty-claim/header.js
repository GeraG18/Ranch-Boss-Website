    ...
    return(
        <div className="relative">
            ...
            py-4 mx-4 max-w-(--breakpoint-xl) h-40 sm:flex-row lg:gap-4 lg:h-56 xl:mx-auto">
                <h1 className="font-['Michroma'] uppercase font-bold text-[1.75rem] leading-10 flex items-center justify-center text-center col-start-1 col-end-4 row-start-1 lg:text-[2rem] lg:leading-12 text-white">{t('warrantyClaim')}</h1>
            </div>
        </div>
    );
    //#endregion
