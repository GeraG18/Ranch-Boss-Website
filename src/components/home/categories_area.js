...
const CategoriesItem = ({category = 'test'}) => {
    ...
    return ( 
        <div className="group relative flex-grow flex-none p-4 before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-[url(/Images/moomoo.webp)] before:bg-no-repeat before:bg-cover 
            ...
            <div className="z-30 flex w-full h-full outline-2 group-hover:outline-secondary-color-20 outline-transparent relative flex-col items-center justify-center">
                ...
                <Link href="/products" className="hidden group-hover:flex col-span-full max-w-7/8 absolute bottom-4 w-full self-center justify-self-center uppercase font-['oswald'] font-medium no-underline text-secondary-color-20 bg-transparent px-10 py-2 bg-[length:200%_100%]
