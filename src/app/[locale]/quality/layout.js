...
//   openGraph: {
//     title: 'Quality That Exceeds Expectations | Horizon Trailers Facebook',
//     description: "Discover Horizon Trailers’ commitment to quality craftsmanship. From durable materials to precision engineering, every trailer is built to exceed industry standards. Trust Horizon Trailers for reliability, performance, and unmatched durability on every job, big or small.",
...
//     title: 'Quality That Exceeds Expectations | Horizon Trailers X',
//     description: "Discover Horizon Trailers’ commitment to quality craftsmanship. From durable materials to precision engineering, every trailer is built to exceed industry standards. Trust Horizon Trailers for reliability, performance, and unmatched durability on every job, big or small.",
...
export async function generateMetadata({ params }) {
  ...
  const t = await getTranslations({ locale, namespace: 'SEOMetadata.Quality' });
  return {
    metadataBase: new URL('https://horizontrailers.com'),
    title: t('title'),
    authors:[{name: "Horizon Trailers LLC"}],
