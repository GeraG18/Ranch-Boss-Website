...
const BottomBar = ({onClickEvent = (clicked='') => {}}) => {
    ...
    return(
        ...
        z-200 font-['lora'] flex flex-col items-center justify-center ${reachesBottom ? "translate-y-[calc(100%+5rem)]" : "translate-y-0"}`}>
            {/* {css(styles.marginContainer, styles.flexRow, styles.justifyBetween, styles.paddingX, styles.hideDesk)} */}
            <div className="mx-4 max-w-screen-lg  w-[calc(100%-2rem)] z-100 xl:mx-auto flex flex-row items-center gap-2 justify-between py-1 pt-4
            lg:hidden">
                {t('summary.totalPrice')}: <span className="uppercase font-semibold flex-none desktopPrice">{currencyFormat(totals.total)}</span>
            </div>
            <div className="mx-4 max-w-screen-lg  w-[calc(100%-2rem)] z-100 xl:mx-auto flex flex-row items-center gap-2 justify-between py-4 lg:py-0">
                ...
                <div className="flex flex-row items-center gap-2 w-fit h-full">
                    ...
                    <button className="flex-none uppercase cursor-pointer relative text-white border-none bg-primary-color lg:hover:bg-gradient-to-b lg:hover:from-secondary-color lg:hover:to-primary-color font-medium  text-[1rem] select-none motion-safe:transition-all motion-reduce:transition-none will-change-auto motion-safe:duration-300
                        flex gap-[2px] h-10 min-w-10 items-center justify-center disabled:cursor-not-allowed disabled:bg-[#7a7a7a] disabled:hover:bg-[#5c5b5b] px-2" onClick={() => {downloadPDF()}}
                    ...
                    <button className="flex-none uppercase cursor-pointer relative text-white border-none bg-primary-color lg:hover:bg-gradient-to-b lg:hover:from-secondary-color lg:hover:to-primary-color font-medium  text-[1rem] select-none motion-safe:transition-all motion-reduce:transition-none will-change-auto motion-safe:duration-300
                        flex gap-[2px] h-10 min-w-10 items-center justify-center disabled:cursor-not-allowed disabled:bg-[#7a7a7a] disabled:hover:bg-[#5c5b5b] px-2" onClick={() => {
